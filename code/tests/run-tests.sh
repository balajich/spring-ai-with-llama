...
if [[ -z "$CHAPTER" ]]; then
    ...
    echo "    $0 chapter-16   ->  chapter-16-ai-agents.feature"
    echo ""
    exit 1
fi
...
case "$CHAPTER" in
    ...
    chapter-15)
        ...
        ;;
    chapter-16)
        APP_MODULE="chapter-16-ai-agents"
        TEST_CLASS="Chapter16Test"
        ;;
    *)
        echo ""
        echo "  ERROR: Unknown chapter '$CHAPTER'"
        echo "  Available: chapter-01, chapter-02, chapter-03, chapter-04, chapter-05, chapter-06, chapter-07, chapter-08, chapter-09, chapter-10, chapter-11, chapter-12, chapter-13, chapter-14, chapter-15, chapter-16"
        echo ""
        exit 1
        ;;
esac
